...
class Palette {
  PaletteEntry get seed => const PaletteEntry(Color.fromARGB(235, 34, 34, 34));
  PaletteEntry get text => const PaletteEntry(Color.fromARGB(237, 49, 49, 49));
  PaletteEntry get backgroundMain => const PaletteEntry(Color(0xffa2fff3));
  PaletteEntry get backgroundLevelSelection =>
      const PaletteEntry(Color.fromARGB(255, 43, 43, 43));
